...
public sealed class Localizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Polish = new Dictionary<string, string>
    {
        ...
        ["Action.Edit"] = "Edytuj", ["Action.End"] = "Zakończ", ["Action.Delete"] = "Usuń", ["Action.Cancel"] = "Anuluj", ["Action.Save"] = "Zapisz", ["Action.Create"] = "Dodaj", ["Action.Close"] = "Zamknij", ["Action.Clear"] = "Wyczyść", ["Action.Next"] = "Dalej", ["Action.Manage"] = "Zarządzaj",
        ["Field.DigitalService"] = "Usługa cyfrowa", ["Field.SelectDigitalService"] = "Wybierz usługę", ["Field.Name"] = "Nazwa", ["Field.Amount"] = "Kwota", ["Field.Currency"] = "Waluta", ["Field.BillingPeriod"] = "Okres rozliczeniowy", ["Field.StartDate"] = "Data rozpoczęcia", ["Field.EndDate"] = "Data zakończenia",
        ["Billing.Monthly"] = "Co miesiąc", ["Billing.Quarterly"] = "Co kwartał", ["Billing.SemiAnnual"] = "Co pół roku", ["Billing.Yearly"] = "Co rok",
        ["Catalog.Title"] = "Wybierz subskrypcję", ["Catalog.Description"] = "Wybierz popularną usługę, aby przejść do jej danych.", ["Catalog.Search"] = "Szukaj subskrypcji", ["Catalog.Available"] = "Dostępne usługi: {0}", ["Catalog.Hint"] = "Wybierz jeden kafelek, aby przejść dalej", ["Catalog.Empty"] = "Brak pasujących usług", ["Catalog.Back"] = "Wróć do katalogu", ["Subscriptions.Categories"] = "Koszt według kategorii", ["Billing.Short.Monthly"] = "mies.", ["Billing.Short.Quarterly"] = "kw.", ["Billing.Short.SemiAnnual"] = "pół roku", ["Billing.Short.Yearly"] = "rok", ["Category.Streaming"] = "Streaming", ["Category.Music"] = "Muzyka", ["Category.Cloud"] = "Chmura", ["Category.Shopping"] = "Zakupy", ["Category.Productivity"] = "Produktywność", ["Category.Design"] = "Projektowanie", ["Category.ArtificialIntelligence"] = "Sztuczna inteligencja", ["Category.Education"] = "Edukacja", ["Category.Gaming"] = "Gry", ["Category.Fitness"] = "Fitness", ["Category.Other"] = "Inne",
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Action.Edit"] = "Edit", ["Action.End"] = "End", ["Action.Delete"] = "Delete", ["Action.Cancel"] = "Cancel", ["Action.Save"] = "Save", ["Action.Create"] = "Add", ["Action.Close"] = "Close", ["Action.Clear"] = "Clear", ["Action.Next"] = "Next", ["Action.Manage"] = "Manage",
        ["Field.DigitalService"] = "Digital service", ["Field.SelectDigitalService"] = "Select a service", ["Field.Name"] = "Name", ["Field.Amount"] = "Amount", ["Field.Currency"] = "Currency", ["Field.BillingPeriod"] = "Billing period", ["Field.StartDate"] = "Start date", ["Field.EndDate"] = "End date",
        ["Billing.Monthly"] = "Monthly", ["Billing.Quarterly"] = "Quarterly", ["Billing.SemiAnnual"] = "Semi-annually", ["Billing.Yearly"] = "Yearly",
        ["Catalog.Title"] = "Choose a subscription", ["Catalog.Description"] = "Choose a popular service to continue to its details.", ["Catalog.Search"] = "Search subscriptions", ["Catalog.Available"] = "Available services: {0}", ["Catalog.Hint"] = "Choose one tile to continue", ["Catalog.Empty"] = "No matching services", ["Catalog.Back"] = "Back to catalog", ["Subscriptions.Categories"] = "Cost by category", ["Billing.Short.Monthly"] = "mo.", ["Billing.Short.Quarterly"] = "qtr.", ["Billing.Short.SemiAnnual"] = "half-year", ["Billing.Short.Yearly"] = "yr.", ["Category.Streaming"] = "Streaming", ["Category.Music"] = "Music", ["Category.Cloud"] = "Cloud", ["Category.Shopping"] = "Shopping", ["Category.Productivity"] = "Productivity", ["Category.Design"] = "Design", ["Category.ArtificialIntelligence"] = "Artificial intelligence", ["Category.Education"] = "Education", ["Category.Gaming"] = "Gaming", ["Category.Fitness"] = "Fitness", ["Category.Other"] = "Other",
    ...
    private static readonly IReadOnlyDictionary<string, string> German = new Dictionary<string, string>
    {
        ...
        ["Action.Edit"] = "Bearbeiten", ["Action.End"] = "Beenden", ["Action.Delete"] = "Löschen", ["Action.Cancel"] = "Abbrechen", ["Action.Save"] = "Speichern", ["Action.Create"] = "Hinzufügen", ["Action.Close"] = "Schließen", ["Action.Clear"] = "Leeren", ["Action.Next"] = "Weiter", ["Action.Manage"] = "Verwalten",
        ["Field.DigitalService"] = "Digitaler Dienst", ["Field.SelectDigitalService"] = "Dienst auswählen", ["Field.Name"] = "Name", ["Field.Amount"] = "Betrag", ["Field.Currency"] = "Währung", ["Field.BillingPeriod"] = "Abrechnungszeitraum", ["Field.StartDate"] = "Startdatum", ["Field.EndDate"] = "Enddatum",
        ["Billing.Monthly"] = "Monatlich", ["Billing.Quarterly"] = "Vierteljährlich", ["Billing.SemiAnnual"] = "Halbjährlich", ["Billing.Yearly"] = "Jährlich",
        ["Catalog.Title"] = "Abonnement auswählen", ["Catalog.Description"] = "Wählen Sie einen bekannten Dienst, um zu den Details zu gelangen.", ["Catalog.Search"] = "Abonnements suchen", ["Catalog.Available"] = "Verfügbare Dienste: {0}", ["Catalog.Hint"] = "Wählen Sie eine Kachel, um fortzufahren", ["Catalog.Empty"] = "Keine passenden Dienste", ["Catalog.Back"] = "Zurück zum Katalog", ["Subscriptions.Categories"] = "Kosten nach Kategorie", ["Billing.Short.Monthly"] = "Mon.", ["Billing.Short.Quarterly"] = "Quart.", ["Billing.Short.SemiAnnual"] = "Halbjahr", ["Billing.Short.Yearly"] = "Jahr", ["Category.Streaming"] = "Streaming", ["Category.Music"] = "Musik", ["Category.Cloud"] = "Cloud", ["Category.Shopping"] = "Einkaufen", ["Category.Productivity"] = "Produktivität", ["Category.Design"] = "Design", ["Category.ArtificialIntelligence"] = "Künstliche Intelligenz", ["Category.Education"] = "Bildung", ["Category.Gaming"] = "Spiele", ["Category.Fitness"] = "Fitness", ["Category.Other"] = "Andere",
